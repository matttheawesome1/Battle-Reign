...
namespace Battle_Reign {
    public class Slider : Option {
        public Slider(string text, int width, float def, Vector2 position) {
            Text = text;
        ...
        public override void Update(GameTime gt) {
            ...
            if (Mouse.Hitbox.Intersects(Hitbox) && Mouse.MouseDown) {
        ...
        public override void Draw(SpriteBatch sb) {
            ...
            sb.Draw(BlankTexture, PositionSlider, new Rectangle(Point.Zero, SliderSize), Color.White, 0f, Origin, 1f, SpriteEffects.None, 0f);
            sb.Draw(BlankTexture, PositionSlider, new Rectangle(Point.Zero, new Point((int) (SliderSize.X * Progress), SliderSize.Y)), Color.FromNonPremultiplied(136, 0, 0, 255), 0f, Origin, 1f, SpriteEffects.None, 0f);
