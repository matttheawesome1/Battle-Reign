...
namespace Battle_Reign {
    public class Tab : GameObject {
        public Tab(string text, int index, TabManager parent) {
            ...
            Button = new Button(true, "", new Vector2(), (s, e) => Select(), "");
            Button.Position = new Vector2(Position.X + index * Button.Background.Width + (index > 0 ? padding * index : 0), Position.Y - Button.Background.Height - 15);
        ...
        public void Draw(SpriteBatch sb) {
            ...
            sb.Draw(null, Position, new Rectangle(Point.Zero, Size), Color, 0f, Vector2.Zero, 1f, SpriteEffects.None, 0f);
